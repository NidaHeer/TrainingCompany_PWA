                    ...
                    <div class="panel-body">
                        <form action="" method="POST">
                            <div class="form-group">
                                ...
                                <input type="password" class="form-control" id="old-password" name="old" placeholder="Old Password" required>
                            </div>
                            <div class="form-group">
                                <label for="new-password">New Password</label>
                                <input type="password" class="form-control" id="new-password" name="new" placeholder="New Password" required>
                            </div>
                            <div class="form-group">
                                <label for="confirm-password">Confirm Password</label>
                                <input type="password" class="form-control" id="confirm-password" name="confirm" placeholder="Confirm Password" required>
                            </div>
